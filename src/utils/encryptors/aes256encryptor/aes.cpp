...
std::vector<unsigned char> AES::EncryptECB(std::vector<unsigned char> in,
  ...
  unsigned char* out =
      EncryptECB(VectorToArray(in), static_cast<unsigned int>(in.size()),
                 VectorToArray(key));
  std::vector<unsigned char> v =
      ArrayToVector(out, static_cast<unsigned int>(in.size()));
  delete[] out;
  return v;
}
...
std::vector<unsigned char> AES::DecryptECB(std::vector<unsigned char> in,
                                           std::vector<unsigned char> key) {
  unsigned char* out =
      DecryptECB(VectorToArray(in), static_cast<unsigned int>(in.size()),
                 VectorToArray(key));
  std::vector<unsigned char> v =
      ArrayToVector(out, static_cast<unsigned int>(in.size()));
  delete[] out;
...
std::vector<unsigned char> AES::EncryptCBC(std::vector<unsigned char> in,
  ...
  unsigned char* out =
      EncryptCBC(VectorToArray(in), static_cast<unsigned int>(in.size()),
...
std::vector<unsigned char> AES::DecryptCBC(std::vector<unsigned char> in,
                                           ...
                                           std::vector<unsigned char> iv) {
  unsigned char* out =
      DecryptCBC(VectorToArray(in), static_cast<unsigned int>(in.size()),
                 VectorToArray(key), VectorToArray(iv));
  std::vector<unsigned char> v =
      ArrayToVector(out, static_cast<unsigned int>(in.size()));
  delete[] out;
...
std::vector<unsigned char> AES::EncryptCFB(std::vector<unsigned char> in,
                                           ...
                                           std::vector<unsigned char> iv) {
  unsigned char* out =
      EncryptCFB(VectorToArray(in), static_cast<unsigned int>(in.size()),
                 VectorToArray(key), VectorToArray(iv));
  std::vector<unsigned char> v = ArrayToVector(
      out, static_cast<unsigned int>(static_cast<unsigned int>(in.size())));
  delete[] out;
  return v;
}
...
std::vector<unsigned char> AES::DecryptCFB(std::vector<unsigned char> in,
                                           ...
                                           std::vector<unsigned char> iv) {
  unsigned char* out =
      DecryptCFB(VectorToArray(in), static_cast<unsigned int>(in.size()),
                 VectorToArray(key), VectorToArray(iv));
  std::vector<unsigned char> v =
      ArrayToVector(out, static_cast<unsigned int>(in.size()));
  delete[] out;
